...
public class PhoneNumberUtil {
    ...
    public static void main(String[] args) {
        PhoneModel address = getPhoneModel("13272495546");

        //获得城市名
        System.out.println(address.getCityName());
        //获得运营商
        System.out.println(address.getCarrier());
        //获得省名
        System.out.println(address.getProvinceName());

        Boolean isModel = checkPhoneNumber("15575585418");

        //是否为有效手机号
        System.out.println(isModel);

        String geo = getGeo("15575585418");
